...
function __wbg_adapter_16(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h627ac154104fda7e(arg0, arg1);
}
...
function getImports() {
    ...
    imports.wbg.__wbg_new_986c3ced83821d2d = function(arg0, arg1) {
        const ret = new Intl.Collator(getObject(arg0), getObject(arg1));
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_compare_1e0778d040a7824f = function(arg0) {
        const ret = getObject(arg0).compare;
        return addHeapObject(ret);
    };
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('sort_text_international_rust_wasm_pwa_bg.wasm', import.meta.url);
    }
    const imports = getImports();
